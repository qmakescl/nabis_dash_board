...
NABIS 원본 데이터(XLS)는 [지방시대위원회 - NABIS균형발전종합정보시스템](https://www.nabis.go.kr/) 웹사이트에서 별도로 다운로드하여 처리하였다.
...
- 출처: [지방시대위원회 - NABIS균형발전종합정보시스템](https://www.nabis.go.kr/) > 균형발전지표 > 시도/시군구별 다운로드
